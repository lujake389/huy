...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/lujake389/huy/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/lujake389/uy/main/re"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+66934567688}]]}' 
...
wget -q https://raw.githubusercontent.com/lujake389/huy/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
